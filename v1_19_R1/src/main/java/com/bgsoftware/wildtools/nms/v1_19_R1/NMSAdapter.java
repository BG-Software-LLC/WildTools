package com.bgsoftware.wildtools.nms.v1_19_R1;
...
import com.bgsoftware.wildtools.nms.v1_19_R1.mappings.net.minecraft.server.level.ChunkProviderServer;
import com.bgsoftware.wildtools.nms.v1_19_R1.mappings.net.minecraft.world.entity.Entity;
import com.bgsoftware.wildtools.nms.v1_19_R1.mappings.net.minecraft.world.inventory.ContainerProperty;
import com.bgsoftware.wildtools.nms.v1_19_R1.mappings.net.minecraft.world.item.Item;
import com.bgsoftware.wildtools.nms.v1_19_R1.mappings.net.minecraft.world.item.ItemStack;
import com.bgsoftware.wildtools.nms.v1_19_R1.mappings.net.minecraft.world.level.ChunkCoordIntPair;
import com.bgsoftware.wildtools.nms.v1_19_R1.mappings.net.minecraft.world.level.World;
import com.bgsoftware.wildtools.nms.v1_19_R1.mappings.net.minecraft.world.level.block.Block;
import com.bgsoftware.wildtools.nms.v1_19_R1.mappings.net.minecraft.world.level.block.state.IBlockData;
import com.bgsoftware.wildtools.nms.v1_19_R1.mappings.net.minecraft.world.level.chunk.Chunk;
...
public final class NMSAdapter implements com.bgsoftware.wildtools.nms.NMSAdapter {
    ...
    @Remap(classPath = "net.minecraft.world.level.block.Blocks", name = "FARMLAND", type = Remap.Type.FIELD, remappedName = "cn")
    private static final Block FARMLAND_BLOCK = new Block(Blocks.cn);
    @Remap(classPath = "net.minecraft.world.item.Items", name = "DIAMOND_AXE", type = Remap.Type.FIELD, remappedName = "nE")
    ...
    public int getExpFromBlock(org.bukkit.block.Block block, Player player) {
        ...
        return blockData.getBlock().getExpDrop(blockData.getHandle(), (WorldServer) world.getHandle(), blockPosition,
                CraftItemStack.asNMSCopy(player.getInventory().getItemInMainHand()), true);
    }
