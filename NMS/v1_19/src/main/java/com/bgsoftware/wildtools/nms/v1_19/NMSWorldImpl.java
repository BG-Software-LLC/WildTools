...
public class NMSWorldImpl extends com.bgsoftware.wildtools.nms.v1_19.AbstractNMSWorld {

    @Override
    protected int getExpDrop(BlockState blockState, ServerPlayer serverPlayer, BlockPos blockPos) {
        return blockState.getBlock().getExpDrop(blockState, serverPlayer.getLevel(), blockPos, serverPlayer.getMainHandItem(), true);
    }
